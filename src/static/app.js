document.addEventListener("DOMContentLoaded", () => {
  ...
  function showMessage(message, type) {
    ...
    window.clearTimeout(messageDiv.messageTimeout);
    messageDiv.messageTimeout = window.setTimeout(() => {
                  ...
                  <li class="participant-item">
                    ...
                    >
                      <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                        <path d="M9 3.75A1.75 1.75 0 0 1 10.75 2h2.5A1.75 1.75 0 0 1 15 3.75V4h4a.75.75 0 0 1 0 1.5h-1.06l-.59 11.2A2.75 2.75 0 0 1 14.62 19H9.38a2.75 2.75 0 0 1-2.73-2.3L6.06 5.5H5a.75.75 0 0 1 0-1.5h4V3.75ZM10.75 3.5a.25.25 0 0 0-.25.25V4h3v-.25a.25.25 0 0 0-.25-.25h-2.5Zm-2.2 2 .56 10.12c.03.6.53 1.08 1.13 1.08h5.46c.6 0 1.1-.48 1.13-1.08L17.39 5.5H8.55ZM10 8.25a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0v-4a.75.75 0 0 1 .75-.75Zm4 0a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0v-4a.75.75 0 0 1 .75-.75Z"/>
                      </svg>
                    </button>
                  </li>`
              )
              .join("")
          : '<li class="participants-empty">No participants signed up yet</li>';
